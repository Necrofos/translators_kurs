...
public:
  ...
  virtual void enterAddExpr(ExprParser::AddExprContext *ctx) = 0;
  virtual void exitAddExpr(ExprParser::AddExprContext *ctx) = 0;

  virtual void enterCompOp(ExprParser::CompOpContext *ctx) = 0;
  virtual void exitCompOp(ExprParser::CompOpContext *ctx) = 0;
